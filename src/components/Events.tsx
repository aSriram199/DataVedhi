...
const Events = () => {
  ...
  return (
    <section id="events" className="relative min-h-screen bg-gradient-to-b from-[#3b82f6] via-[#818cf8] to-[#93c5fd] dark:from-neutral-950 dark:via-black dark:to-neutral-950">
