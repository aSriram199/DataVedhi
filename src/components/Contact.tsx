...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative md:h-[40vh] bg-gradient-to-b from-[#93c5fd] via-[#818cf8] to-[#3b82f6] dark:from-black dark:via-neutral-950 dark:to-neutral-950">
